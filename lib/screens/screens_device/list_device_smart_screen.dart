...
import 'package:log_in/screens/screens_device/add_smart_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    child:FloatingActionButton(
          ...
          BottomNavigationBar(
           ...
           selectedItemColor: Color(0xFFFFC800),
            items: [
              ...
              BottomNavigationBarItem(icon: Icon(Icons.apps,), label: 'تقرير استهلاك المبنى'),
            ],
      ...
      /*Center(
        ...
        body:
        Padding(padding: EdgeInsets.only(top: 25.0,left: 10.0, right: 10.0),
               child:TabBarView(
              controller: _tabController,
